...
struct oracle_constraint_gent
{
  ...
  std::vector<symbol_exprt> input_parameters;
  std::vector<symbol_exprt> return_parameters;
  exprt constraint;
  
  oracle_constraint_gent(
    const irep_idt _binary_name,
    const std::vector<symbol_exprt> & _input_parameters,
    const std::vector<symbol_exprt> & _output_parameters,
